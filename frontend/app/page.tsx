  ...
  chips: [
    {
      ...
      className: "border-cyan-400/45 bg-cyan-500/15 text-cyan-100",
    },
    {
    ...
    },
    {
      ...
      className: "border-violet-400/45 bg-violet-500/15 text-violet-100",
    },
  ],
};
...
export default function EntryPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-[#09182a] to-[#040b17] p-4 sm:p-6">
      ...
      >
        <div className="mb-7 space-y-3 text-center">
          <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl">
            {ENTRY_COPY.titlePrefix} <span className="text-emerald-300">{ENTRY_COPY.titleAccent}</span>
          </h1>
          <p className="mx-auto max-w-2xl text-base text-slate-300 sm:text-lg">
            {ENTRY_COPY.subtitle}
          </p>
          <div className="flex flex-wrap items-center justify-center gap-2 pt-1 text-xs font-medium text-slate-300">
          ...
          >
            <div className="relative h-12 w-full rounded-full border border-slate-600/90 bg-slate-900/80 p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
              ...
              <TabsList className="relative z-10 grid h-full w-full grid-cols-2 bg-transparent p-0">
                <TabsTrigger
                  value="github"
                  className="h-10 rounded-full border border-transparent text-slate-400 aria-selected:font-semibold aria-selected:text-emerald-100 data-active:font-semibold data-active:text-emerald-100 focus-visible:ring-2 focus-visible:ring-emerald-400/40 focus-visible:ring-offset-0"
                >
                  GitHub Profile
                </TabsTrigger>
                <TabsTrigger
